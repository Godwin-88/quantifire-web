...
Prefer video? This post accompanies **Episode 4** of the Quantifaya animated series. Watch on YouTube or scroll down for the full written deep-dive with interactive charts and code.

<div className="my-8 not-prose">
  <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-slate-900 border border-slate-800">
    <iframe
      src="https://www.youtube.com/embed/PLACEHOLDER_EP04"
      title="Episode 4: Value at Risk - How Much Can You Lose on a Bad Day?"
  ...
  <div className="mt-4 flex items-center justify-center gap-4 text-sm">
    <a
      href="https://youtu.be/PLACEHOLDER_EP04"
      target="_blank"
    ...
    <a href="#what-is-var" className="text-slate-400 hover:text-slate-200 transition-colors">
      Continue reading ↓
    </a>
  </div>
</div>
