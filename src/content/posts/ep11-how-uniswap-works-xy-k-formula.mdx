...
Prefer video? This post accompanies **Episode 11** of the Quantifaya animated series. Watch on YouTube or scroll down for the full written deep-dive with interactive charts and code.

<div className="my-8 not-prose">
  <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-slate-900 border border-slate-800">
    <iframe
      src="https://www.youtube.com/embed/8vbwOamg9N8"
      title="Episode 11: How Uniswap Actually Works - The x·y=k Formula"
  ...
  <div className="mt-4 flex items-center justify-center gap-4 text-sm">
    <a
      href="https://youtu.be/8vbwOamg9N8"
      target="_blank"
    ...
    <a href="#the-amm-model-what-changes" className="text-slate-400 hover:text-slate-200 transition-colors">
      Continue reading ↓
    </a>
  </div>
</div>
